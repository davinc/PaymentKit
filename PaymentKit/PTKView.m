...
#define DefaultBoldFont [UIFont fontWithName:ET_FONT_Regular size:18.0f]

#define kPTKViewPlaceholderViewAnimationDuration 0.25

#define kPTKViewCardExpiryFieldEndX 100
#define kPTKViewCardCVCFieldEndX 250

#define kPTKViewCardExpiryFieldStartX 100 + 200
#define kPTKViewCardCVCFieldStartX 250 + 200
...
- (void)setup
{
	...
	//    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, 290, 44);
	self.backgroundColor = [UIColor clearColor];
	
	self.backgroundImageView = [[UIImageView alloc] initWithFrame:self.bounds];
	self.backgroundImageView.image = [[UIImage imageNamed:@"textfield_bg"]
									  resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
	[self addSubview:self.backgroundImageView];
	
	self.innerView = [[UIView alloc] initWithFrame:CGRectMake(62, 12, self.frame.size.width - 62, 20)];
	...
	//    self.opaqueOverGradientView.backgroundColor = [UIColor colorWithWhite:1 alpha:1.0000];
...
- (void)setupPlaceholderView
{
	self.placeholderView = [[UIImageView alloc] initWithFrame:CGRectMake(7, 7, 48, 30)];
...
- (void)setupCardNumberField
{
	self.cardNumberField = [[PTKTextField alloc] initWithFrame:CGRectMake(0, 0, 200, 20)];
	...
	//	self.cardNumberField.backgroundColor = [UIColor lightGrayColor];
...
- (void)setupCardExpiryField
{
	self.cardExpiryField = [[PTKTextField alloc] initWithFrame:CGRectMake(kPTKViewCardExpiryFieldStartX, 0, 120, 20)];
	...
	//	self.cardExpiryField.backgroundColor = [UIColor lightGrayColor];
...
- (void)setupCardCVCField
{
	...
	//	self.cardCVCField.backgroundColor = [UIColor lightGrayColor];
...
- (void)stateMeta
{
	...
	CGFloat frameX = 0 - (cardNumberSize.width - lastGroupSize.width);
...
{
	if ( [textField.inputView isKindOfClass:[ETNumericalInputView class]] )
		((ETNumericalInputView*)textField.inputView).target = textField;
...
{
	if ( [textField.inputView isKindOfClass:[ETNumericalInputView class]] )
		((ETNumericalInputView*)textField.inputView).target = nil;
}
...
{
	//	self.backgroundImageView.image = [[UIImage imageNamed:@"textfield_bg_error"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
	//	self.backgroundImageView.image = [[UIImage imageNamed:@"textfield_bg_highlighted"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
	//	self.backgroundImageView.image = [[UIImage imageNamed:@"textfield_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
	if (errors) {
		self.backgroundImageView.image = [[UIImage imageNamed:@"textfield_bg_error"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
